...
\textbf{Keypoint extraction (PoseNet / MoveNet)} $\rightarrow$
\textbf{51-dim vector: 17 joints $\times$ $(x,y,\mathrm{conf})$} $\rightarrow$
\textbf{REBA angle labelling} $\rightarrow$
\textbf{MLP: Linear(51,128), ReLU, Dropout; Linear(128,64), ReLU, Dropout; Linear(64,4), Softmax} $\rightarrow$
\textbf{0 Neutral; 1 Trunk dev.\,$>30^\circ$; 2 Neck $>15^\circ$; 3 Overreach $>60^\circ$}
\end{minipage}}
